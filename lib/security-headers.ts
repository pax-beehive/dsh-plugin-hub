...
export function withSecurityHeaders(response: Response, request?: Request) {
  ...
  headers.set(
    ...
    [
      ...
      "img-src 'self' data: https://workoscdn.com https://*.workoscdn.com https://www.google-analytics.com https://www.googleadservices.com https://www.googletagmanager.com https://bzr.openai.com https://www.google.com",
      "object-src 'none'",
